...
<script setup>
  ...
  // Obtener datos del álbum cuando el componente se monta
  ...
  // Llamar a fetchAlbumInfo cuando se monta el componente o cuando cambia el id en la ruta
  onMounted(() => {
    const albumId = route.params.id;
    fetchAlbumInfo(albumId);
  });

  // Observar los cambios en el id de la ruta y volver a cargar los datos
  watch(() => route.params.id, (newId) => {
    fetchAlbumInfo(newId);
